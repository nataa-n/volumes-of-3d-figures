...
<body>
<header>Icosahedron</header>
<main>
    <p id="formula">V =(5(3+√5)/12)a<sup>3</sup></p>
    <div id="figure_content">
        <form action="<?php	$theme ?>" method="POST">
		<div id="sizes"><div id="first_part">a =</div><div id="second_part"><input type="number" name="a" class="number_input"></div></div> 
    </div>
...
if($_POST){
	$a=$_POST['a'];
	$v=(5*(3+sqrt(5))/12)*$a*$a*$a;
}
echo '<div><img src="images/icosahedron.png" id="img_figures"></div>';
echo '<footer>';
